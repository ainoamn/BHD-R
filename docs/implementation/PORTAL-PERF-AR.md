...
| 0.4.73 | تسخين فوري + prefetch كل الشريط + إبقاء كل لوحات التشغيل + كاش صفحات dashboard/stays | تنقّل شريط المالك أقرب لـ SPA |
| 0.4.75 | تسجيل شجرة الصفحة الحقيقية + prefetch متدرّج للتفاصيل + History API للأقسام + soft save للعقار | مسودات النماذج تبقى عند الرجوع |
