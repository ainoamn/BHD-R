...
**المسار:** `/{ar|en}/{owner|developer}/properties/new` و `…/properties/:id/edit`  
**المكوّن:** `apps/web/src/components/property-wizard.tsx`  
**آخر تحديث:** `main` / إصدار **0.2.59** (2026-08-30) — تجاوب موحّد: [`PORTAL-ADAPTIVE-PROPERTIES-AR.md`](./PORTAL-ADAPTIVE-PROPERTIES-AR.md)
...
- شريط المراحل (سطح المكتب): المتبقي **أحمر**، المكتمل بإطار أخضر، الحالية مميّزة.
- على الجوال (≤960px): شريط رفيع + «n/7 · اسم المرحلة» بدل شبكة الدوائر الكبيرة؛ حقول مضغوطة؛ بعد اختيار قائمة ينتقل التركيز للحقل التالي.
